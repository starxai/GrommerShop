...
function Profile(){
    ...
    return(
       ...
       {img ? <img src={URL.createObjectURL(img)} className="profile-pic" /> : <img src={img} className="profile-pic" /> }
       <label for="first-img"
      ><img src={img2} style={{height:"38px",width:"38px",borderRadius:"50%",marginTop:"150px",position:"relative",right:"45px"}}/> </label> 
        <input type="file" accept="image/jpeg, image/png, image/jpg"  onChange={handleimageclick2} className="profilepic-input" id="first-img"/>
       </div>
       </div>
