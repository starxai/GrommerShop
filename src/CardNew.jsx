        ...
        <div className="content_and_cards">
                ...
                <div id="carouselExampleIndicators" class="carousel slide ">
                    ...
                    <div className="slide-carousel-button">
                        <button style={{ color: "#fff",zIndex:300 }} class="carousel-control-prev" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="prev">
                            <span style={{border: "1px solid yellow",position: "relative", bottom: "289px",fontSize:"30px"}} class="bi bi-arrow-left-circle" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button style={{ color: "#fff",zIndex:300 }} class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="next">
                            <span  style={{border: "1px solid yellow",position: "relative", bottom: "289px",fontSize:"30px"}} class="bi bi-arrow-right-circle" aria-hidden="true"></span>
                            <span class="visually-hidden">Next</span>
                        </button>
                            ...
                            <div class="d-flex ">
                                ...
                                <div class="cards-container">
                                    <div className="cards-positions-container">
                                        ...
                                        <span className="location-icon"><i style={{ color: "white" }} class="bi bi-geo-alt-fill"></i>Banjara Hills, 1.3 km away</span>
                                    </div>
                            ...
                            <div class="d-flex">
                                <div class="cards-container">
                                    <div className="cards-positions-container">
                                        ...
                                        <span className="heart-icon"><i style={{ color: "white", fontSize: "20px" }} class="bi bi-heart"></i></span>
                                        <span className="location-icon"><i style={{ color: "white" }} class="bi bi-geo-alt-fill"></i>Gachibowli, 800 m away</span>
                                    </div>
                                    <div className="card-position">
                                        <div class="card-body">
