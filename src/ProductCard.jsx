        ...
        <div className="product-saloon-container">
          <div className="product-card">
            <div className="cards-positions-container productcard-cardspostion">
              <img
                width={276}
                src="https://i.ibb.co/z5GSkLx/lindsay-cash-Md-Dha-Fsn-CQ-unsplash-2.jpg"
                alt="..."
                className="groomer-card1"
              />
              ...
              <span className="location-icon product-locationicons">
                Concern :Dry hair
              </span>
            </div>
            <div className="card-position">
              <div class="card-body cardsposition-body">
                <p className="product-name-data">Keune Shampoo</p>{" "}
                <p className="product-rating-data">
                  4/5
          ...
          <div className="product-card">
            <div className="cards-positions-container productcard-cardspostion">
              <img
                width={276}
                src="https://i.ibb.co/cwLDDhH/lindsay-cash-Md-Dha-Fsn-CQ-unsplash-2-2.jpg"
                alt="..."
                className="groomer-card1"
              />
              <span className="heart-icon">
            ...
            <div className="card-position">
              <div class="card-body cardsposition-body">
                <p className="product-name-data">WellaCondioner </p>{" "}
                <p className="product-rating-data">
                  4.2/5
                  <span className="product-rating-icon">
                    <i
          ...
          <div className="product-card groomerhomepage-card3">
            <div className="cards-positions-container productcard-cardspostion">
              <img
                width={276}
                src="https://i.ibb.co/DQDhD65/lindsay-cash-Md-Dha-Fsn-CQ-unsplash-2-3.jpg"
                alt="..."
                className="groomer-card1"
              />
              <span className="heart-icon">
            ...
            <div className="card-position">
              <div class="card-body cardsposition-body">
                <p className="product-name-data">Shea Moisture oil</p>{" "}
                <p className="product-rating-data">
                  4/5
                  <span className="product-rating-icon">
                    <i
          ...
          <div>
            <div className="product-card groomerhomepage-card3">
              ...
              <div className="card-position ">
                <div class="card-body cardsposition-body">
                  <p className="product-name-data">Olivient hair oil</p>{" "}
                  <p className="product-rating-data">
                    4/5
                    <span className="product-rating-icon">
                      <i
