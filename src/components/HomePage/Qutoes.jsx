    ...
    return (
        <div className="groomer-homepage-quotes-maincontainer">
            ...
            <div id="carouselExampleCaptions" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div className="quotation-place-container">
                            ...
                            <div className="quote-symbol homepage-quote-symbol">
                ...
                <button class="carousel-control-prev hompage-quotes-indicator" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next hompage-quotes-indicator" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="next">
