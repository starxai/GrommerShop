...
function Filterapplyy({onChange, filterOptions,value,setFilteredCardsLocation,setFilterOptions,setsaloonname,setsalonnameloading,setsaloonlocationloading,toggle,options}) {
...
*/}
    ...
    return (
        ...
        <input className="search-bar d-sm-inline searching-salonname" placeholder="Search Here" name="salonname" onChange={handlesalonname}/>
           <div className={`filtercard-position ${toggle ? "show" : "hide"}`}> 
                   ...
                   <ul className=" nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start accordion-main-container" id="menu">
                ...
                <div class="accordion-item filterapply-accordionmain">
                    ...
                    <div class="accordion-body">
                    <ul className=" nav flex-column ms-1" id="submenu2.2" data-bs-parent="#menu">
                        <li>
