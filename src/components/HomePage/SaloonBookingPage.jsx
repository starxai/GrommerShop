...
function PageBooking() {
  ...
  const { salon_name, salon_address, selectedTreatments, id } =
    location.state || {};
              ...
              <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                ...
                >
                  ...
                  <div className="booking-saloon-header">
                    <h3
                      className="salonbookingpage-salonname"
                      style={{
                        height: "32px",
                    ...
                    <p
                      className="salonbookingpage-salonadress"
                      style={{ fontSize: "16px" }}
                    >
                      {salon_address}
                    </p>
                  ...
                  <div>
                    ...
                    <div
                      className="gap-provider salondetailspage-date"
                    ...
                    <div
                      className="gap-provider salondetailspage-time"
                      style={{ marginLeft: "60px" }}
                    >
