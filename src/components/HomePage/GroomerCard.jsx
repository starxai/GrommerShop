        ...
        <div className="row d-flex homepage-groomercards-maindiv">
          <div class="card card_1 col-10 col-md-6 col-lg-3 col-xl-2">
            ...
            <div class="card-body-groomer">
              ...
              >
                Crafting tailored styles with precision, passion, and
                unparalleled expertise daily.
              </i>
            </div>
          </div>
          <div class="card card_2 col-12 col-md-4 col-lg-6 col-xl-4 groomer-3cardsdisplay">
            <img
              src="https://i.ibb.co/9hTwnjb/pexels-nikolaos-dimou-1319459-1.jpg"
              class="card-img2"
              alt="..."
          ...
          <div class="card card_3 col-2 col-md-2 col-lg-3 col-xl-1">
            <img
              src="https://i.ibb.co/xzvcdBY/jeppe-monster-Ccj-IK1h5j-Rk-unsplash-1.jpg"
              class="card-img3"
              alt="..."
            />
            <div class="card-second-body-groomer">
              <i
                ...
                className="goomer-3cards-para"
              >
                Complete your grooming routine with our platform connecting you
                to top-notch salons and barbershops.
              </i>
            </div>
          </div>
        </div>
