            ...
            <div className="saloon-page-container">
                <div id="carouselExampleIndicators" className="carousel slide">
                    <div className="carousel-indicators">
                        <button style={{ height: "9px", width: "11px", backgroundColor: "#fff", borderRadius: "50%" }} type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" aria-label="Slide 1"></button>
                        <button style={{ height: "9px", width: "11px", backgroundColor: "#fff", borderRadius: "50%" }} type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" className="active" aria-current="true" aria-label="Slide 2"></button>
                    ...
                    <div className="carousel-inner slotbooking-carousel" style={{ width: '570px' }}>
                        <div className="carousel-item slotbooking-carouselimg" >
                            <img src="https://i.ibb.co/GR0RH5x/20240227-203542-1.jpg" alt="" className="slotbooking-carouselimg" />
                        </div>
                ...
                <div className="saloon-header-container">
                    <div className="saloon-data-container">
                        <div>
                            <div className="pb-2 mb-4 salon-link-pages">
                                <Link to='/saloon'><span style={{ color: "white", fontFamily: "Poppins", fontSize: "20px", fontWeight: 300 }}>salons</span></Link>
                                <span><i style={{ color: "white" }} className="bi bi-chevron-right"></i></span>
                                <span style={{ color: "white", fontFamily: "Poppins", fontSize: "20px", fontWeight: 500 }}> saloon details</span>
                            </div>
                            <h1 className="salon-detailed-name" style={{ color: "white", fontFamily: "Avegas Royale", fontWeight: 700, fontSize: "40px" }}>{salon_name}</h1>
                            <h3 className="salon-detailed-adress" style={{ color: "white", fontFamily: "Poppins", fontWeight: 400, fontSize: "22px" }}>{salon_address} <span className="salon-detailed-map" style={{ color: "gold", fontFamily: "Poppins", fontWeight: 400, fontSize: "22px" }}>view in map</span></h3>
                        </div>
                    ...
                    <div></div>
                    <div>
                        <p className="saloon-paragraph" style={{ color: "white", fontFamily: "Poppins", fontWeight: 400, fontSize: "18px" }}>{salon_description}</p>
                    </div>
                    <div>
                        <div className="icon-container">
                            <div className="salon-details-features"  style={{display:"flex",flexDirection:"row"}}>
                                {feature_Ac && (
                                    <div className="col">
                                        <i style={{ color: "white", fontSize: "60px" }} className="bi bi-pc-horizontal"></i>
                                        <p style={{ color: "white", fontFamily: "Poppins", fontWeight: 400, fontSize: "16px" }}>AC available</p>
                                    </div>
                                )}
                                {feature_wifi && (
                                    <div className="col">
                                        <i style={{ color: "white", fontSize: "60px" }} className="bi bi-wifi"></i>
                                        <p style={{ color: "white", fontFamily: "Poppins", fontWeight: 400, fontSize: "16px" }}>Free wifi</p>
                                    </div>
                                )}
                                {feature_parking && (
                                    <div className="col">
                                        <i style={{ color: "white", fontSize: "60px" }} className="bi bi-p-square"></i>
                                        <p style={{ color: "white", fontFamily: "Poppins", fontWeight: 400, fontSize: "16px" }}>Bikes and Car parking</p>
                                    </div>
                                )}
                            </div>
                        </div>
                    </div>
                    <hr className="salonedetailspage" style={{ color: "white",width:"600px" }} />
                    <div className="booking-purpse-container">
                        <div className="salondetailspage-treatment">
                            <h3 style={{ color: "white", paddingTop: "20px", fontFamily: "Poppins", fontWeight: 400, fontSize: "20px" }}>Treatment</h3>
                       <div className="app">
...

                                {
                                    isDropdownOpen && (
                                        <div className="dropdown-content">
                                             {
                                  salon_features ? salon_services.map((data,index) => (
                                            <div className="dropdown-item">
                                            <label style={{color:"white"}}>
                                                <input
                                                type="checkbox"
                                                checked={selectedTreatments.includes(data.service_name)}
                                                onChange={(e) => handleCheckboxChange(e, data.service_name)}
                                                />  {data.service_name}
                    ...
                    {/*       <select className="select-treatment" name="" id="" onChange={(e) =>setservice(e.target.value)}>
                        ...
                        <div className="booking-persons">
                            <h3 style={{ color: "white", fontFamily: "Poppins", fontWeight: 400, fontSize: "20px" }}>Booking For :</h3>
                            <select style={{ color: "white", backgroundColor: "black", fontFamily: "Poppins", fontWeight: 400, fontSize: "16px" }} className="selecting-persons" name="" id="">
                                <option disabled selected value="">Select persons</option>
                                <option  style={{ color: "white", fontFamily: "Poppins", fontWeight: 400, fontSize: "16px" }} value="">1 person</option>
                                <option style={{ color: "white", fontFamily: "Poppins", fontWeight: 400, fontSize: "16px" }} value="">2 person</option>
                                <option style={{ color: "white", fontFamily: "Poppins", fontWeight: 400, fontSize: "16px" }} value="">3 person</option>
                                <option style={{ color: "white", fontFamily: "Poppins", fontWeight: 400, fontSize: "16px" }} value="">4 persons</option>
                            </select>
                        </div>
                    </div>
                    <div>
                    ...
                    <button className="book-slot" onClick={() =>handleslotbooking()}>Book Time Slot</button>
                      {/*  <Link to="/booking" >
                            <button className="book-slot">Book Time Slot</button>
                        </Link> */}
                    </div>
                    <hr className="salonedetailspage" style={{ color: "gold",width:"600px" }} />
                    ...
                    <div className="salonsdetailedpage-review" style={{color:"white",width:"600px",height:"113px",backgroundColor:"#222222"}}>
                        <h6 style={{marginLeft:"50px",paddingTop:"20px"}}>Suresh</h6>
                        <div style={{marginLeft:"50px"}}>Stars</div>
                        <div style={{marginLeft:"50px"}}>Services are very good hover the behaviour of dresses are little bit rude</div>
                    </div>
                </div>
            </div>
        </div>
