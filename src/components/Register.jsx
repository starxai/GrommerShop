                    ...
                    {!isRegistered && (
                        ...
                        <div className="checkbox-container">
                            <input 
                              ...
                              />
                             <span style={{ fontFamily: "Poppins" }}>I accept the terms and conditions, including the privacy</span> <br />
                        </div>
                        <button type="submit" className="btn-register" style={{ fontFamily: "Poppins" }}> Register</button>
                        </form>
                        )}
                        {isRegistered && (
