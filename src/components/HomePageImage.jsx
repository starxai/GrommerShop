    ...
    <div className="groomer-background-maincontainer">
      ...
      <div id="carouselExampleRide" class="carousel slide" data-bs-ride="true">
        <div class="carousel-indicators">
          <button
            className="carousel-indicate-one"
            style={{ width: "16px", height: "14px", borderRadius: "50%" }}
            type="button"
        ...
        <div class="carousel-inner groomer-background-container">
          <div class="carousel-item active groomer-background-carousel">
            <img
              src="https://i.ibb.co/DLCWm4D/20240227-203542-1-1.jpg"
              class="d-block w-100"
              alt="..."
              className="groomer-background-img"
            />
          </div>
        ...
        >
          <span
            class="carousel-control-prev-icon homepage-background-next-icon"
            aria-hidden="true"
          ></span>
        ...
        >
          <span
            class="carousel-control-next-icon homepage-background-next-icon"
            aria-hidden="true"
          ></span>
