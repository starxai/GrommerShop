...
//    console.log(cartoonpic)
    ...
    const [filteredCardsLocation, setFilteredCardsLocation] = useState(true);
   ...
   useEffect(() => {
    ...
    const handleLocationChange = (location) => {
      ...
      let update = allCards.filter((item) => item.address === location);
                    ...
                    <div class="row flex-nowrap">
                        ...
                        <div class="col-auto col-md-2 col-xl-3  px-sm-3 px-0 ">
                            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-3 text-white min-vh-100  ">
                                <div className="one-side-border"> <button style={{color:"white",backgroundColor:"black",width:"100px"}} onClick={handleFilterApply}>Apply</button>
                                    ...
                                    <a href="#" class="nav-link px-0 align-middle">
                                        ...
                                        <select name="" id="">
                                            <option value="">sexual Oreantation</option>
                                            <input type="radio" />
                                            <input type="radio" />
    ...
    <div id="collapseOne" className="accordion-collapse collapse show" data-bs-parent="#accordionExample">
      <div className="accordion-body">
        ...
        <label htmlFor="">Female</label>
                                          ...
                                          {/*  <div class="accordion" id="accordionExample" style={{backgroundColor:"black"}}>
                                                <div class="accordion-item" style={{backgroundColor:"black",color:"white",border:"none"}}>
                                                  <h2 class="accordion-header">   
                                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style={{backgroundColor:"black",color:"white",border:"none",borderBottom:"none"}}>
                                                            Sexual-orentation
                                                        </button>
                                                     </h2>
                                                    <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                                        <div class="accordion-body" >
                                                            <input onClick={(e)=>genderConformation(e.target.value)} value="male" name="gender" type="radio" onChange={handlefilterchange}/> <label htmlFor="">male</label>
                                                            <br />
                                                            <input onClick={(e)=>genderConformation(e.target.value)} value="Female" name="gender" type="radio" onChange={handlefilterchange} /> <label htmlFor="">Female</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                    </div>
                            */}
                                            ...
                                            <span class="ms-1 d-none d-sm-inline"><p style={{ color: "white" }}>sexual Oreantation</p>
                                            </span></a>
                                        <ul class="collapse nav flex-column ms-1" id="submenu2" data-bs-parent="#menu">
                                            <li class="w-100">
                                                <a class="nav-link px-0"> <span class="d-none d-sm-inline"><input style={{ backgroundColor: "black" }} type="radio" /><span style={{ color: "white" }} >Male</span></span></a>
                                            </li>
                                            <li>
                                                <a class="nav-link px-0"> <span class="d-none d-sm-inline"><input className="radio-button" type="radio" /><span style={{ color: "white" }}>Female</span></span></a>
                                            </li>
                                        </ul>  */}
                                        </li>
                     ...
                     <div class="col py-3">
                            ...
                            <div className="listing-card-saloon-container">
                               ...
                               <>
                                ...
                                <div  style={{marginLeft:"10px",display:"grid",gridTemplateColumns:"300px 300px 300px"}} >
